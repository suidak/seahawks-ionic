...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_fundraiser__ = __webpack_require__(251);
...
var FundraiserService = (function () {
    function FundraiserService(http) {
        var _this = this;
        this.http = http;
        this.url = 'http://192.168.43.117:18080/seahawks-web/rest/fundraiser';
        //private url : string = 'http://172.19.11.147:18080/seahawks-web/rest/fundraiser';
        this.fundraisers = [];
        this.getAllFundraisers().subscribe(function (resp) {
            _this.fundraisers = (resp);
        });
    }
    FundraiserService.prototype.searchFundraisers = function (params) {
        if (!params) {
            return this.fundraisers;
        }
        return this.fundraisers.filter(function (item) {
...
var map = {
	...
	"../pages/fundraiser-search/fundraiser-search.module": [
		346,
		13
	],
...
var FirstRunPage = 'FundraiserListPage';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pipes_textlimit_textlimit__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_donations_donation_service__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_fundraisers_fundraiser_service__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_FoundReports_FoundReports__ = __webpack_require__(229);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_splash_screen__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_status_bar__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_storage__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ngx_translate_core__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ngx_translate_http_loader__ = __webpack_require__(293);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ionic_angular__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_native_geocoder__ = __webpack_require__(233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__mocks_providers_items__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__providers_providers__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__app_component__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_google_maps__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_social_sharing__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_speech_recognition__ = __webpack_require__(231);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_7__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_0__pipes_textlimit_textlimit__["a" /* TextlimitPipe */]
                //FoundReportPage
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_15_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_19__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/fundraiser-search/fundraiser-search.module#FundraiserSearchPageModule', name: 'FundraiserSearchPage', segment: 'fundraiser-search', priority: 'low', defaultHistory: [] },
            ...
            bootstrap: [__WEBPACK_IMPORTED_MODULE_15_ionic_angular__["b" /* IonicApp */]],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_19__app_component__["a" /* MyApp */],
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_2__providers_fundraisers_fundraiser_service__["a" /* FundraiserService */],
                __WEBPACK_IMPORTED_MODULE_1__providers_donations_donation_service__["a" /* DonationService */],
                __WEBPACK_IMPORTED_MODULE_22__ionic_native_speech_recognition__["a" /* SpeechRecognition */],
                __WEBPACK_IMPORTED_MODULE_18__providers_providers__["a" /* Api */],
                __WEBPACK_IMPORTED_MODULE_17__mocks_providers_items__["a" /* Items */],
                __WEBPACK_IMPORTED_MODULE_5__providers_FoundReports_FoundReports__["a" /* FoundReports */],
                ...
                __WEBPACK_IMPORTED_MODULE_16__ionic_native_native_geocoder__["a" /* NativeGeocoder */],
                __WEBPACK_IMPORTED_MODULE_11__ionic_native_status_bar__["a" /* StatusBar */],
                { provide: __WEBPACK_IMPORTED_MODULE_18__providers_providers__["c" /* Settings */], useFactory: provideSettings, deps: [__WEBPACK_IMPORTED_MODULE_12__ionic_storage__["b" /* Storage */]] },
                // Keep this to enable Ionic's runtime error handling during development
                { provide: __WEBPACK_IMPORTED_MODULE_7__angular_core__["ErrorHandler"], useClass: __WEBPACK_IMPORTED_MODULE_15_ionic_angular__["c" /* IonicErrorHandler */] }
            ]
        })
    ], AppModule);
    return AppModule;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TextlimitPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
//# sourceMappingURL=textlimit.js.map
...
"use strict";
/* unused harmony export FoundReports */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var FoundReports = (function () {
    ...
    FoundReports.prototype.query = function (params) {
        ...
        return this.foundReports.filter(function (foundReport) {
            for (var key in params) {
                var field = foundReport[key];
                if (typeof field == 'string' && field.toLowerCase().indexOf(params[key].toLowerCase()) >= 0) {
                    return foundReport;
                }
                else if (field == params[key]) {
    ...
    FoundReports.prototype.add = function (foundReport) {
        this.foundReports.push(foundReport);
        console.log(foundReport);
    };
    FoundReports.prototype.delete = function (foundReport) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_pages__ = __webpack_require__(228);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mocks_providers_reports__ = __webpack_require__(317);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__donations_donation_service__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fundraisers_fundraiser_service__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_api__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mocks_providers_items__ = __webpack_require__(188);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_4__mocks_providers_items__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_5__settings_settings__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_6__user_user__["a"]; });
/* unused harmony reexport FundraiserService */
/* unused harmony reexport DonationService */
/* unused harmony reexport FoundReports */
